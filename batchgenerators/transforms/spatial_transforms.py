...
from batchgenerators.augmentations.spatial_transformations import augment_spatial, augment_spatial_2, augment_channel_translation, \
...
class FlipVectorAxisTransform(AbstractTransform):
    """ Expects as input an image_x with 3 3D-vectors at each voxels, encoded as a nine-channel image_x. Will randomly
