...
class TestCrop(unittest.TestCase):
    ...
    def test_center_crop_3D(self):
        ...
        np.testing.assert_array_equal(data[:, :, 10:20, 10:20, 10:20], d, err_msg="crop not equal image_x center")
        np.testing.assert_array_equal(seg[:, :, 10:20, 10:20, 10:20], s, err_msg="crop not equal image_x center")
    ...
    def test_center_crop_2D(self):
        ...
        np.testing.assert_array_equal(data[:, :, 10:20, 10:20], d, err_msg="crop not equal image_x center")
        np.testing.assert_array_equal(seg[:, :, 10:20, 10:20], s, err_msg="crop not equal image_x center")
    ...
    def test_center_crop_3D_padding(self):
        ...
        np.testing.assert_array_equal(tmp_d, data, err_msg="Original data is not included in padded image_x")
        self.assertAlmostEqual(np.sum(d.flatten()), np.sum(data.flatten()), msg="Padding of data is not zero")

        np.testing.assert_array_equal(tmp_s, seg, err_msg="Original segmentation is not included in padded image_x")
    ...
    def test_center_crop_2D_list(self):
        ...
        np.testing.assert_array_equal(data[:, :, 10:20, 5:25], d, err_msg="crop not equal image_x center")
        np.testing.assert_array_equal(seg[:, :, 10:20, 5:25], s, err_msg="crop not equal image_x center")
    ...
    def test_center_crop_3D_list(self):
        ...
        np.testing.assert_array_equal(data[:, :, 10:20, 5:25, 0:29], d, err_msg="crop not equal image_x center")
        np.testing.assert_array_equal(seg[:, :, 10:20, 5:25, 0:29], s, err_msg="crop not equal image_x center")
